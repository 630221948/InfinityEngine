...
var _MapNodeCache: infinity.Bitmap[] = [];                          //地图元素数组

var imageConfigList: infinity.RES.imageConfig[] = [];
...
window.onload = () => {
    ...
    infinity.res.load("../resources/GameMap.json", () => {
    ...
    infinity.res.load("../resources/PlayerIdle.json", () => {
...
function onLoadJsonResource(index: number, nodeCounts: number, configArray: infinity.res.ImageConfig[]) {            //使用递归进行地图加载

    if (index < nodeCounts) {
        infinity.res.load(configArray[index].url, () => {
...
function creatGameScene() {                                                              //主场景中的逻辑
    ...
    //创建移动动画
    var PLAYER_WALK_1: infinity.MovieClipFrameData = { name: "PLAYER_WALK_1.png" };
    var PLAYER_WALK_2: infinity.MovieClipFrameData = { name: "PLAYER_WALK_2.png" };
    var PLAYER_WALK_3: infinity.MovieClipFrameData = { name: "PLAYER_WALK_3.png" };
    var PLAYER_WALK_4: infinity.MovieClipFrameData = { name: "PLAYER_WALK_4.png" };
    var PLAYER_WALK_5: infinity.MovieClipFrameData = { name: "PLAYER_WALK_5.png" };
    var PLAYER_WALK_6: infinity.MovieClipFrameData = { name: "PLAYER_WALK_6.png" };
    var playerWalkData: infinity.MovieClipData = { name: "PLAYER_WALK", totalFrame: 6, frames: [PLAYER_WALK_1, PLAYER_WALK_2, PLAYER_WALK_3, PLAYER_WALK_4, PLAYER_WALK_5, PLAYER_WALK_6] };
    var playerWalkAnim: infinity.MovieClip = new infinity.MovieClip(playerWalkData);
    playerWalkAnim.alpha = 0;

    //创建待机动画
    var PLAYER_IDLE_1: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_1.png" };
    var PLAYER_IDLE_2: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_2.png" };
    var PLAYER_IDLE_3: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_3.png" };
    var PLAYER_IDLE_4: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_4.png" };
    var PLAYER_IDLE_5: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_5.png" };
    var PLAYER_IDLE_6: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_6.png" };
    var PLAYER_IDLE_7: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_7.png" };
    var PLAYER_IDLE_8: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_8.png" };
    var PLAYER_IDLE_9: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_9.png" };
    var PLAYER_IDLE_10: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_10.png" };
    var PLAYER_IDLE_11: infinity.MovieClipFrameData = { name: "PLAYER_IDLE_11.png" };
    var playerIdleData: infinity.MovieClipData = { name: "PLAYER_IDLE", totalFrame: 11, frames: [PLAYER_IDLE_1, PLAYER_IDLE_2, PLAYER_IDLE_3, PLAYER_IDLE_4, PLAYER_IDLE_5, PLAYER_IDLE_6, PLAYER_IDLE_7, PLAYER_IDLE_8, PLAYER_IDLE_9, PLAYER_IDLE_10, PLAYER_IDLE_11] };
    var playerIdleAnim: infinity.MovieClip = new infinity.MovieClip(playerIdleData);
    ...
    var m: StateMachine = new StateMachine(stage, playerIdleAnim, playerContainer, playerWalkAnim);

    stage.addEventListener(infinity.TouchingEventType.MOUSE_DOWN, (e) => {
